...
public class MainCLIApps{
    public static void main(String[] args){
        ...
        final String playerFilePath = "Project/database_txt_files/players.txt";

        database.loadPlayers(playerFilePath);
        ...
        while (true){
            ...
            try{
                ...
                switch (choice){
                    case 1:
                        searchPlayersMenu(input, database);
                        break;
                    case 2:
                        searchClubsMenu(input, database);
                        break;
                    case 3:
                        addPlayerMenu(input, database);
                        break;
                    case 4:
                        database.savePlayers(playerFilePath);
    ...
    private static void searchPlayersMenu(Scanner input, PlayerDatabase database){
        while (true){
            System.out.println();
            ...
            try{
                ...
                switch (choice){
                    ...
                    case 2:
                        ...
                        var list1 = database.searchByCountryAndClub(country, club);
                        System.out.println();
                    ...
                    case 3:
                        ...
                        var list2 = database.searchByPosition(position);
                        System.out.println();
                    ...
                    case 4:
                        ...
                        var list3 = database.searchBySalaryRange(l, u);
                        System.out.println();
                        for (var x : list3) x.showDetails();
                        break;
        
                    case 5:
                        var list4 = database.countCountryWisePlayers();
                        System.out.println();
    ...
    private static void searchClubsMenu(Scanner input, PlayerDatabase database){
        while (true){
            System.out.println();
            ...
            try{
                ...
                switch (choice){
                    case 1:
                        ...
                        var maxSalaryList = database.findMaxSalaryPlayersInClub(clubMaxSalary);
                    ...
                    case 2:
                        ...
                        var maxAgeList = database.findMaxAgePlayersInClub(clubMaxAge);
                    ...
                    case 3:
                        ...
                        var maxHeightList = database.findMaxHeightPlayersInClub(clubMaxHeight);
                    ...
                    case 4:
                        ...
                        var totalSalary = database.countTotalYearlySalaryOfClub(clubTotalSalary);
                        System.out.println();
    ...
    private static void addPlayerMenu(Scanner input, PlayerDatabase database){
        try{
            System.out.println();
            ...
            database.addPlayer(name, country, age, height, club, position, joursey, weeklySalary);
        }
        catch (NumberFormatException e){
            System.out.println();
            System.out.println("Invalid input. Please enter a number.");
